      ...
      <div style={{ background: '#FFFFFF', border: '1px solid #D6D9E8', borderRadius: '4px', padding: '0.8rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.7rem', boxShadow: '0 1px 2px rgba(28,1,64,.06)' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '0.4rem' }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.4rem' }}>
            ...
            <button style={{ fontFamily: 'inherit', fontSize: '0.82rem', cursor: 'pointer', background: '#E9EBF5', color: '#1C0140', border: '1px solid #E9EBF5', borderRadius: '999px', padding: '0.28rem 0.75rem', display: 'inline-flex', alignItems: 'center', gap: '0.4rem', transition: 'all 200ms' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#376BE9'} onMouseLeave={(e) => e.currentTarget.style.borderColor = '#E9EBF5'}>
